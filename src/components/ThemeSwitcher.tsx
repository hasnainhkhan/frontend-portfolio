...
const themes: ThemeDef[] = [
  ...
  },
  {
    ...
    dark: {
      ...
      "--input": "233 30% 18%",
      "--ring": "30 100% 60%",
      "--glow-primary": "0 0 30px hsl(30 100% 60% / 0.2)",
      "--glow-primary-strong": "0 0 60px hsl(30 100% 60% / 0.3)",
    },
    light: {
      "--background": "0 0% 100%",
      ...
      "--input": "30 10% 85%",
      "--ring": "30 100% 50%",
      "--glow-primary": "0 0 30px hsl(30 100% 50% / 0.1)",
      "--glow-primary-strong": "0 0 60px hsl(30 100% 50% / 0.15)",
    },
    gradientDark: "linear-gradient(135deg, hsl(30 100% 60%), hsl(145 75% 27%))",
    gradientLight: "linear-gradient(135deg, hsl(30 100% 50%), hsl(233 100% 25%))",
  },
  {
    name: "Ocean Blue",
    preview: "#3B82F6",
