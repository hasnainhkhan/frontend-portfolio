...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // PDF Reader
    "pdf.label": "PDF Reader",
    "pdf.heading1": "Upload & ",
    "pdf.heading2": "Listen",
    "pdf.desc": "Upload any PDF and listen to the entire document in English, Urdu, Arabic, or Hindi.",
    "pdf.upload": "Click to upload PDF",
    "pdf.uploadHint": "Supports .pdf files",
    "pdf.extracting": "Extracting text...",
    "pdf.extracted": "Text extracted successfully",
    "pdf.error": "Failed to extract text from PDF",
    "pdf.invalidFile": "Please upload a valid PDF file",
    "pdf.page": "Page",
    "pdf.pages": "pages",
    "pdf.reading": "Reading page",
    "pdf.listenIn": "Listen in",
    "pdf.play": "Listen to Document",
    "pdf.stop": "Stop Reading",
    "pdf.uploadAnother": "Upload Another",
  },
  ur: {
    ...
    "pdf.label": "پی ڈی ایف ریڈر",
    "pdf.heading1": "اپلوڈ کریں اور ",
    "pdf.heading2": "سنیں",
    "pdf.desc": "کوئی بھی PDF اپلوڈ کریں اور پوری دستاویز انگریزی، اردو، عربی، یا ہندی میں سنیں۔",
    "pdf.upload": "PDF اپلوڈ کرنے کے لیے کلک کریں",
    "pdf.uploadHint": ".pdf فائلز سپورٹ کرتا ہے",
    "pdf.extracting": "ٹیکسٹ نکالا جا رہا ہے...",
    "pdf.extracted": "ٹیکسٹ کامیابی سے نکالا گیا",
    "pdf.error": "PDF سے ٹیکسٹ نکالنے میں ناکامی",
    "pdf.invalidFile": "براہ کرم ایک درست PDF فائل اپلوڈ کریں",
    "pdf.page": "صفحہ",
    "pdf.pages": "صفحات",
    "pdf.reading": "صفحہ پڑھ رہا ہے",
    "pdf.listenIn": "سنیں",
    "pdf.play": "دستاویز سنیں",
    "pdf.stop": "پڑھنا بند کریں",
    "pdf.uploadAnother": "دوسرا اپلوڈ کریں",
  },
  ar: {
    "nav.about": "عني",
    ...
    "pdf.heading1": "ارفع و ",
    "pdf.heading2": "استمع",
    "pdf.desc": "ارفع أي ملف PDF واستمع إلى المستند كاملاً بالإنجليزية أو الأردية أو العربية أو الهندية.",
    "pdf.upload": "انقر لرفع PDF",
    "pdf.uploadHint": "يدعم ملفات .pdf",
    "pdf.extracting": "جاري استخراج النص...",
    "pdf.extracted": "تم استخراج النص بنجاح",
    "pdf.error": "فشل في استخراج النص من PDF",
    "pdf.invalidFile": "يرجى رفع ملف PDF صالح",
    "pdf.page": "صفحة",
    "pdf.pages": "صفحات",
    "pdf.reading": "قراءة صفحة",
    "pdf.listenIn": "استمع بـ",
    "pdf.play": "استمع إلى المستند",
    "pdf.stop": "إيقاف القراءة",
    "pdf.uploadAnother": "رفع ملف آخر",
  },
  hi: {
    ...
    "about.card3.desc": "Basic AWS, DynamoDB, PostgreSQL, और क्लाउड-रेडी एप्लिकेशन डिप्लॉय करने का अनुभव।",
    ...
    "pdf.label": "PDF रीडर",
    "pdf.heading1": "अपलोड करें और ",
    "pdf.heading2": "सुनें",
    "pdf.desc": "कोई भी PDF अपलोड करें और पूरा दस्तावेज़ अंग्रेजी, उर्दू, अरबी, या हिंदी में सुनें।",
    "pdf.upload": "PDF अपलोड करने के लिए क्लिक करें",
    "pdf.uploadHint": ".pdf फाइलें समर्थित हैं",
    "pdf.extracting": "टेक्स्ट निकाला जा रहा है...",
    "pdf.extracted": "टेक्स्ट सफलतापूर्वक निकाला गया",
    "pdf.error": "PDF से टेक्स्ट निकालने में विफल",
    "pdf.invalidFile": "कृपया एक वैध PDF फाइल अपलोड करें",
    "pdf.page": "पेज",
    "pdf.pages": "पेज",
    "pdf.reading": "पेज पढ़ रहा है",
    "pdf.listenIn": "सुनें",
    "pdf.play": "दस्तावेज़ सुनें",
    "pdf.stop": "पढ़ना बंद करें",
    "pdf.uploadAnother": "दूसरा अपलोड करें",
  },
};
